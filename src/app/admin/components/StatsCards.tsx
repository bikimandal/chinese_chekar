...
const StatsCards = memo(function StatsCards({
  ...
  return (
    <div className="grid grid-cols-3 sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4 md:gap-6 mb-6 sm:mb-8">
      <div className="bg-linear-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-2 sm:p-4 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-700/50 hover:border-amber-500/30 transition-all duration-300">
        <div className="flex items-center justify-between mb-1.5 sm:mb-3 md:mb-4">
          <div className="w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-linear-to-br from-blue-500/20 to-blue-600/20 rounded-lg sm:rounded-xl flex items-center justify-center">
      ...
      <div className="bg-linear-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-2 sm:p-4 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-700/50 hover:border-amber-500/30 transition-all duration-300">
        <div className="flex items-center justify-between mb-1.5 sm:mb-3 md:mb-4">
          <div className="w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-linear-to-br from-amber-500/20 to-orange-600/20 rounded-lg sm:rounded-xl flex items-center justify-center">
      ...
      <div className="bg-linear-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm p-2 sm:p-4 md:p-6 rounded-lg sm:rounded-xl md:rounded-2xl border border-slate-700/50 hover:border-red-500/30 transition-all duration-300 sm:col-span-2 lg:col-span-1">
        <div className="flex items-center justify-between mb-1.5 sm:mb-3 md:mb-4">
          <div className="w-6 h-6 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-linear-to-br from-red-500/20 to-red-600/20 rounded-lg sm:rounded-xl flex items-center justify-center">
