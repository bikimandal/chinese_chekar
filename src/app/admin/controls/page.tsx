            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {Array.isArray(products) && products.map((product) => (
                  <div
                    key={product.id}
                    className="bg-slate-900/50 border border-slate-700/50 rounded-xl p-6 hover:border-amber-500/50 transition-all"
                  >
                    {product.image && (
                      <div className="mb-4">
                        <img
                    ...
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-slate-800/50 border border-slate-700 text-slate-300 hover:text-white hover:border-amber-500/50 rounded-lg transition-all"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-2 bg-red-500/10 border border-red-500/30 text-red-400 hover:bg-red-500/20 rounded-lg transition-all"
                      >
